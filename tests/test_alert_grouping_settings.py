...
class TestAlertGroupingSettingsTools(unittest.TestCase):
    ...
    @patch("pagerduty_mcp.tools.alert_grouping_settings.get_client")
    def test_put_alert_grouping_setting_success(self, mock_get_client):
        ...
        result = put_alert_grouping_setting("PAGS123", request)
    ...
    @patch("pagerduty_mcp.tools.alert_grouping_settings.get_client")
    def test_put_alert_grouping_setting_wrapped_response(self, mock_get_client):

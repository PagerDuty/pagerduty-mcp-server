...
class TestScheduleTools(unittest.TestCase, ContextTestCase):
    ...
    def test_list_schedules_no_filters(self, mock_paginate):
        ...
        query = ScheduleQuery()
        result = list_schedules(ctx=self.mock_context, query_model=query)
    ...
    def test_list_schedules_paginate_error(self, mock_paginate):
        ...
        with self.assertRaises(Exception) as context:
            list_schedules(ctx=self.mock_context, query_model=query)
    ...
    def test_get_schedule_success(self):
        ...
        result = get_schedule(ctx=self.mock_context, schedule_id="SCHED123")
    ...
    def test_get_schedule_client_error(self):
        ...
        with self.assertRaises(Exception) as context:
            get_schedule(ctx=self.mock_context, schedule_id="SCHED123")
    ...
    def test_create_schedule_override_success(self):
        ...
        result = create_schedule_override("SCHED123", override_request, ctx=self.mock_context)

        # Verify API call        # Verify that datetime objects were converted to ISO format
    ...
    def test_create_schedule_override_multiple_overrides(self):
        ...
        # Verify API call        # Verify that datetime objects were converted to ISO format for both overrides
        expected_json = override_request.model_dump()
        expected_json["overrides"][0]["start"] = "2024-12-25T00:00:00"
        expected_json["overrides"][0]["end"] = "2024-12-26T00:00:00"
    ...
    def test_create_schedule_override_client_error(self):
        ...
        with self.assertRaises(Exception) as context:
            create_schedule_override("SCHED123", override_request, ctx=self.mock_context)
    ...
    def test_list_schedule_users_success(self):
        ...
        result = list_schedule_users("SCHED123", ctx=self.mock_context)
    ...
    def test_list_schedule_users_client_error(self):
        ...
        with self.assertRaises(Exception) as context:
            list_schedule_users("SCHED123", ctx=self.mock_context)
    ...
    def test_create_schedule_success(self):
        ...
        result = create_schedule(ctx=self.mock_context, create_model=request)
    ...
    def test_create_schedule_api_error(self):
        ...
        with self.assertRaises(Exception) as context:
            create_schedule(request, ctx=self.mock_context)
    ...
    def test_update_schedule(self):
        ...
        result = update_schedule(ctx=self.mock_context, schedule_id="SCHED123", update_model=request)
    ...
    def test_update_schedule_with_restrictions(self):
        """Test update_schedule with restrictions."""        # Reset any side effects
        ...
        _ = update_schedule("SCHED123", request, ctx=self.mock_context)
    ...
    def test_update_schedule_api_error(self):
        ...
        with self.assertRaises(Exception) as context:
            update_schedule(ctx=self.mock_context, schedule_id="SCHED123", update_model=request)

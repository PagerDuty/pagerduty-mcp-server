...
class GetIncidentQuery(BaseModel):
    ...
    include: list[IncidentIncludeOption] | None = Field(
        default=None,
...
class Incident(BaseModel):
    ...
    assignees: list[UserReference] | None = Field(
        default=None,
        description="Users assigned to the incident. "
        "Included when requested via include[]=assignees.",
    )

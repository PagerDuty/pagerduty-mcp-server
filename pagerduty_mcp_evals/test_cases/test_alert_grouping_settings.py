...
class AlertGroupingSettingsCompetencyTest(AgentCompetencyTest):
...
ALERT_GROUPING_SETTINGS_COMPETENCY_TESTS = [
    ...
    AlertGroupingSettingsCompetencyTest(
        ...
        expected_tool_calls=[MockToolCall(name="get_alert_grouping_setting", parameters={"setting_id": "PAGS123"})],
    ...
    AlertGroupingSettingsCompetencyTest(
        ...
        expected_tool_calls=[
            MockToolCall(
                name="put_alert_grouping_setting",
                parameters={
                    "setting_id": "PAGS123",
                    "update_model": {
                        "alert_grouping_setting": {
    ...
    AlertGroupingSettingsCompetencyTest(
        ...
        expected_tool_calls=[MockToolCall(name="delete_alert_grouping_setting", parameters={"setting_id": "PAGS456"})],

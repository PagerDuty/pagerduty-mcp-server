...
| -------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | --------- |
| [Incident Investigation](./incident-investigation)             | `list_incidents`, `get_incident`, `list_incident_notes`, `list_alerts_from_incident`, `list_incident_related_change_events` | Read-only |

...
- Use [Tool Filtering](../configuration/tool-filtering.md) with an allow list of `list_oncalls`, `list_schedules`, `list_incidents`, `list_incident_notes`, `get_user_data` to keep the AI scoped to handoff tasks only

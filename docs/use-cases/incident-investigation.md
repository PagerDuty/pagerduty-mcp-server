...
- Combine with [Tool Filtering](../configuration/tool-filtering.md) to expose only the investigation tools, keeping the AI focused on diagnostics rather than remediation
